...
$srcPath = "C:\Users\piiai\.gemini\antigravity-ide\brain\5db7981a-6836-4dcc-a238-6de675619cdd\media__1785810726172.png"
...
# Find bounding box of non-white / dark bed pixels
...
$targetPng = "c:\Users\piiai\OneDrive\Desktop\CONSTRUCTORA\assets\images\icons\icon-habitaciones.png"
$outBmp.Save($targetPng, [System.Drawing.Imaging.ImageFormat]::Png)
...
$svgPath = "c:\Users\piiai\OneDrive\Desktop\CONSTRUCTORA\assets\images\icons\icon-habitaciones.svg"
[System.IO.File]::WriteAllText($svgPath, $svgContent)

$bmp.Dispose()
$outBmp.Dispose()

Write-Host "Processed exact user bed image to icon-habitaciones.png and icon-habitaciones.svg!"
